...
pub type ArcErrorHandler = Arc<dyn ErrorHandler + Send + Sync + 'static>;
...
pub type RwLockReadGuardVecArcFnPinBoxSendSync<'a> =
    RwLockReadGuard<'a, Vec<Arc<dyn FnPinBoxSendSync>>>;
